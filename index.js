...
Алгоритм підрахунку:
1. Знайди всі добові зведення ОВА (повідомлення від начальників ОВА зі словами "за минулу добу", "упродовж доби", "за добу"). Це — головне джерело по кожній області.
2. Якщо для області є добове зведення ОВА — використовуй ТІЛЬКИ його цифри. Ігноруй будь-які оперативні новини по містах цієї ж області, бо вони вже включені в добове зведення.
3. Якщо для області є ТІЛЬКИ оперативна новина (без добового зведення ОВА) — використовуй її цифри.
4. Збери назви всіх областей з постраждалими.

Приклад правильного підрахунку:
- "Харків: 15 поранених" (оперативна) + "Харківська ОВА за добу: 3 загиблих, 25 поранених" → беремо 3 загиблих, 25 поранених (ігноруємо 15)
- "Дніпропетровська ОВА: 7 поранених" (тільки оперативна, без добового зведення) → беремо 7 поранених
